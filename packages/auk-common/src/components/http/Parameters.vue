    ...
    >
      ...
      <div class="flex">
        <AukButtonSecondary
          ...
          to="https://auk.mamahuhu.dev/documentation/features/rest-api-testing"
          blank
          :title="t('app.wiki')"
          :icon="IconHelpCircle"
        />
...
const props = defineProps<{
  modelValue: AukRESTParam[]
  envs?: AggregateEnvironment[]
}>()

const emit = defineEmits<{
  (e: "update:modelValue", value: Array<AukRESTParam>): void
}>()
...
const workingParams = ref<Array<AukRESTParam & { id: number }>>([
  {
    id: idTicker.value++,
    key: "",
    value: "",
...
watch(
  ...
  (newParamsList) => {
    ...
    const filteredWorkingParams: AukRESTParam[] = pipe(
      workingParams.value,
      A.filterMap(
        flow(
...
const updateParam = (index: number, param: AukRESTParam & { id: number }) => {

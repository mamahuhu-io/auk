...
interface AukRESTResponseHeader {
  key: string
  value: string
}
...
// Backward compatibility types for auk and pm namespaces
...
declare namespace auk {
  ...
  const response: Readonly<{
    ...
    readonly headers: AukRESTResponseHeader[]
  ...
  const expect: AukExpectFunction

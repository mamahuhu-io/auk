...
import { deleteEnvironment, duplicateEnvironment } from "~/store/environments"
...
const edit = ref<typeof AukSmartItem>()
const duplicate = ref<typeof AukSmartItem>()
const exportAsJsonEl = ref<typeof AukSmartItem>()
const deleteAction = ref<typeof AukSmartItem>()

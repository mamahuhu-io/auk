...
import { AUK_MODULES } from "@modules/."
...
export async function createAukApp(
  el: string | Element,
  platformDef: PlatformDef
) {
  await initKernel(getKernelMode())
  ...
  AUK_MODULES.forEach((mod) => mod.onVueAppInit?.(app))
  platformDef.addedAukModules?.forEach((mod) => mod.onVueAppInit?.(app))
  ...
  console.info(
    "%cContribute: https://auk.mamahuhu.io/github",

...
const props = defineProps<{
  modelValue: AukRESTRequestVariable[]
}>()

const emit = defineEmits<{
  (e: "update:modelValue", value: Array<AukRESTRequestVariable>): void
}>()
...
const workingRequestVariables = ref<
  Array<AukRESTRequestVariable & { id: number }>
>([
  {
    id: idTicker.value++,
    key: "",
...
watch(
  ...
  (newRequestVariableList) => {
    ...
    const filteredWorkingRequestVariables: AukRESTRequestVariable[] = pipe(

...
export class SpotlightService extends Service {
  ...
  private analyticsData: AukSpotlightSessionEventData = {}
   ...
   */
  public getAnalyticsData(): AukSpotlightSessionEventData {
   ...
   */
  public setAnalyticsData(data: AukSpotlightSessionEventData, merge = true) {

<template>
  <template v-if="inline">
    <span class="auk-doc-explorer-argument" tabindex="0" @click="handleClick">
      <span class="auk-doc-explorer-argument-name"> {{ arg.name }} </span>:
  ...
  <div
    v-else
    class="auk-doc-explorer-argument"
    tabindex="0"
    @click="handleClick"
  >
    <div class="inline-flex items-center align-bottom">
      ...
      <div class="flex items-center gap-2">
        <span class="auk-doc-explorer-argument-name text-sm py-2 font-normal">
          {{ arg.name }}
        </span>
        :
        <GraphqlTypeLink :type="arg.type" />
    ...
    <div
      ...
      class="auk-doc-explorer-argument-deprecation"
    >
      <div class="auk-doc-explorer-argument-deprecation-label">Deprecated</div>

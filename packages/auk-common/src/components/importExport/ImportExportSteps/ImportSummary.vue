      ...
      <div v-for="feature in visibleFeatures" :key="feature.id">
        ...
        <p class="ml-10 text-secondaryLight">
          ...
          >
            ...
            <template v-else>
              {{
                t("import.import_summary_not_supported_by_auk_import", {
...
> = {
  ...
  postman: {
    ...
    requests: "SUPPORTED",
    responses: "SUPPORTED",
    preRequestScripts: "NOT_SUPPORTED_BY_AUK_IMPORT",
    testScripts: "NOT_SUPPORTED_BY_AUK_IMPORT",
  },
  insomnia: {
    collections: "SUPPORTED",
    requests: "SUPPORTED",
  ...
  har: {
    collections: "SUPPORTED",
    requests: "SUPPORTED",
    responses: "NOT_SUPPORTED_BY_AUK_IMPORT",
    preRequestScripts: "NOT_SUPPORTED_BY_SOURCE",
    testScripts: "NOT_SUPPORTED_BY_SOURCE",
  },
}
...
const countCollections = (collections: AukCollection[]) => {
  ...
  const flattenAukCollections = (_collections: AukCollection[]) => {
    _collections.forEach((collection) => {
      ...
      collection.requests.forEach((request) => {
        ...
        const _request = request as AukRESTRequest
      ...
      flattenAukCollections(collection.folders)
    })
  }

  flattenAukCollections(collections)
...
const featureSupportForImportFormat = computed(() => {
  ...
  if (props.importFormat === "postman") {
    ...
    // Keep default NOT_SUPPORTED_BY_AUK_IMPORT
  }

import { TestResponse } from "@auk/js-sandbox";
...
describe("testRunner", () => {
  let SUCCESS_TEST_RUNNER_RES: E.Either<AukCLIError, TestRunnerRes>,
    FAILURE_TEST_RUNNER_RES: E.Either<AukCLIError, TestRunnerRes>;
  ...
  it("Should fail to execute with test-script-error.", () => {
    expect(FAILURE_TEST_RUNNER_RES).toSubsetEqualLeft(<AukCLIError>{

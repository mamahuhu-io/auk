  ...
  >
    ...
    <div v-if="response == null && isEmbed">
      <AukButtonSecondary
        ...
        to="https://auk.mamahuhu.dev/documentation/features/rest-api-testing#response"
...
import type { AukRESTResponse } from "~/helpers/types/AukRESTResponse"
...
const props = withDefaults(
  defineProps<{
    response: AukRESTResponse | null | undefined
    isEmbed?: boolean
    isLoading?: boolean
  }>(),
  {

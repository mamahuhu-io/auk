...
export const AukBgColors = ["system", "light", "dark", "black"] as const

export type AukBgColor = (typeof AukBgColors)[number]

export const AukAccentColors = [
  "green",
  "teal",
  "blue",
  "indigo",
...
export type AukAccentColor = (typeof AukAccentColors)[number]

...
describe("wsValid", () => {
  ...
  test("returns true for valid URL with Hostname", () => {
    expect(wsValid("wss://echo-websocket.mamahuhu.dev/")).toBe(true)
    expect(wsValid("wss://echo-websocket.mamahuhu.dev")).toBe(true)
  })
...
describe("httpValid", () => {
  ...
  test("returns false for non-http(s) protocol URLs", () => {
    expect(httpValid("wss://echo-websocket.mamahuhu.dev/")).toBe(false)
    expect(httpValid("wss://echo-websocket.mamahuhu.dev")).toBe(false)
...
describe("socketioValid", () => {
  ...
  test("returns true for wss protocol URLs", () => {
    expect(socketioValid("wss://echo-websocket.mamahuhu.dev/")).toBe(true)
    expect(socketioValid("wss://echo-websocket.mamahuhu.dev")).toBe(true)

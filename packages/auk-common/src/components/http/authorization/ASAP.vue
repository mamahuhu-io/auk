...
import { AukRESTAuthASAP } from "@auk/data"
...
const props = defineProps<{
  modelValue: AukRESTAuthASAP
  envs?: AggregateEnvironment[]
}>()

const emit = defineEmits<{
  (e: "update:modelValue", value: AukRESTAuthASAP): void
}>()
...
const algorithms: AukRESTAuthASAP["algorithm"][] = [
  "RS256",
  "RS384",
  "RS512",
  "PS256",

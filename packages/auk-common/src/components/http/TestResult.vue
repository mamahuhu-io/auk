    ...
    >
      <template #body>
        <AukButtonSecondary
          ...
          to="https://auk.mamahuhu.dev/documentation/getting-started/rest/tests"
          blank
...
import { AukTestResult } from "~/helpers/types/AukTestResult"
import {
  globalEnv$,
...
const props = withDefaults(
  defineProps<{
    modelValue: AukTestResult | null | undefined
...
const emit = defineEmits<{
  (e: "update:modelValue", val: AukTestResult | null | undefined): void
}>()

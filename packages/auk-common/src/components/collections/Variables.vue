  ...
  <div class="flex flex-col flex-1">
    <div class="flex flex-1 justify-between items-center pl-4">
      ...
      <AukButtonSecondary
        ...
        to="https://auk.mamahuhu.dev/documentation/features/environments"
        blank
        :title="t('app.wiki')"
        :icon="IconHelpCircle"
      />
    ...
    <div class="flex flex-col border border-divider rounded">
      <AukSmartTabs v-model="selectedEnvOption" render-inactive-tabs>
        <template #actions>
...
import { AukCollectionVariable } from "@auk/data"
...
const props = defineProps<{
  modelValue: AukCollectionVariable[]

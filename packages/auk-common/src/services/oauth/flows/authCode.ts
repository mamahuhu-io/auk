...
import { content } from "@auk/kernel"
import { refreshToken, OAuth2ParamSchema } from "../utils"
import { AuthCodeGrantTypeParams, OAuth2AuthRequestParam } from "@auk/data"
import { getService } from "~/modules/dioc"

// Use the existing schema from auk-data but ensure required arrays
...
export type AuthCodeOauthRefreshParams = {
  interceptorService: KernelInterceptorService

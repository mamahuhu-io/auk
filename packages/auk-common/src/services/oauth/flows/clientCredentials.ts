...
import { RelayRequest, content } from "@auk/kernel"
import { parseBytesToJSON } from "~/helpers/functional/json"
import { refreshToken, OAuth2ParamSchema } from "../utils"
import { ClientCredentialsGrantTypeParams } from "@auk/data"
import { getService } from "~/modules/dioc"

// Use the existing schema from auk-data but add client authentication mode

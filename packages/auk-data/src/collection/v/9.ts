...
import { AukGQLAuth } from "../../graphql/v/9"
import { AukRESTAuth } from "../../rest/v/15/auth"
...
export const V9_SCHEMA = v9_baseCollectionSchema.extend({
  folders: z.lazy(() => z.array(entityRefUptoVersion(AukCollection, 9))),
  ...
  up(old: z.infer<typeof V8_SCHEMA>) {
    ...
    const result: z.infer<typeof V9_SCHEMA> = {
      ...
      folders: old.folders.map((folder) => {
        const result = AukCollection.safeParseUpToVersion(folder, 9)

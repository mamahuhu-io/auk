...
import { toast as sonner } from "@mamahuhu/vue-sonner"
...
/**
 * @deprecated LegacyToast is deprecated and will be removed in a future version. Not recommended for use. Instead import toast from '@auk/ui' and use 'toast.show()'
 */
const legacyToast = {

...
export type AukSupportOptionsMenuItem = {
  id: string
  text: (t: ReturnType<typeof getI18n>) => string
...
export type UIPlatformDef = {
   ...
   * in the app footer.
   */
  additionalFooterMenuItems?: AukFooterMenuItem[]

  /**
   * Additional Support Options menu items shown in the app header
   */
  additionalSupportOptionsMenuItems?: AukSupportOptionsMenuItem[]

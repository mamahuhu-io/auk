...
import { AUK_ENVIRONMENT_REGEX } from "~/helpers/environment-regex"

const isENVInString = (str: string) => AUK_ENVIRONMENT_REGEX.test(str)
...
export class EnvironmentInspectorService extends Service implements Inspector {
  ...
  private validateEnvironmentVariables = (
    ...
    target.forEach((element, index) => {
      ...
      const matches = element.match(AUK_ENVIRONMENT_REGEX)

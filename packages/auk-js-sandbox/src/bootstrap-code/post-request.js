...
;(inputs) => {
  ...
  const toJSON = (input) => {
    ...
    throw new Error(
      "Unsupported input type for auk.response.asJSON(). Expected string or object."
    )
  }
  ...
  const toText = (input) => {
    ...
    throw new Error("Unsupported input type for auk.response.asText()")
  }
  ...
  const toBytes = (input) => {
    ...
    throw new Error("Unsupported input type for auk.response.bytes()")
  }
  ...
  Object.keys(responseProperties).forEach((prop) => {
    Object.defineProperty(aukResponse, prop, {
  ...
  // Add utility methods to aukResponse
  Object.defineProperty(aukResponse, "text", {
    value: () => toText(body),
    writable: false,
    enumerable: true,
    configurable: false,
  ...
  Object.defineProperty(aukResponse, "json", {
    value: () => toJSON(body),
    writable: false,
    enumerable: true,
    configurable: false,
  ...
  Object.defineProperty(aukResponse, "reason", {
    value: () => {
  ...
  Object.defineProperty(aukResponse, "dataURI", {
    value: () => {
  ...
  Object.defineProperty(aukResponse, "jsonp", {
  ...
  ;["url", "method", "params", "headers", "body", "auth"].forEach((prop) => {
    Object.defineProperty(requestProps, prop, {
      ...
      set(_value) {
        throw new TypeError(`auk.request.${prop} is read-only`)
      },
    })
  })
  ...
  Object.defineProperty(requestProps, "variables", {
    ...
    set(_value) {
      throw new TypeError(`auk.request.variables is read-only`)
    },
  })
  ...
  const UNDEFINED_MARKER = "__AUK_UNDEFINED__"
  const NULL_MARKER = "__AUK_NULL__"
  ...
  globalThis.auk = {
    ...
    // Expose fetch as auk.fetch() - save reference before we override global
  ...
  // Make global fetch() an alias to auk.fetch()
  // Both fetch() and auk.fetch() respect interceptor settings
  if (typeof fetch !== "undefined") {
    // auk.fetch is already set from inputs, just create the alias
    globalThis.fetch = globalThis.auk.fetch
  } else if (typeof globalThis.auk?.fetch !== "undefined") {
    // If fetch wasn't available but auk.fetch is, create the global alias
    globalThis.fetch = globalThis.auk.fetch
  }
  ...
  globalThis.pm = {
    environment: {
      ...
      get: (key) => {
        return pmGetWithTracking(
          globalThis.auk.env.active.getRaw,
      ...
      unset: (key) => {
        ...
        return globalThis.auk.env.active.delete(key)
      },
      has: (key) => globalThis.auk.env.active.get(key) !== null,
      clear: () => {
          ...
          if (Array.isArray(selectedEnvs)) {
            selectedEnvs.forEach((envVar) => {
              if (envVar && envVar.key) {
                globalThis.auk.env.active.delete(envVar.key)
              }
            })
          }
        }
        ...
        if (globalThis.__pmEnvKeys) {
          globalThis.__pmEnvKeys.forEach((key) => {
            globalThis.auk.env.active.delete(key)
          })
          ...
          if (Array.isArray(selectedEnvs)) {
            selectedEnvs.forEach((envVar) => {
              if (envVar && envVar.key) {
                ...
                const currentValue = globalThis.auk.env.active.get(envVar.key)
      ...
      replaceIn: (template) => {
        ...
        return template.replace(/\{\{([^}]+)\}\}/g, (match, varName) => {
          const value = globalThis.auk.env.active.get(varName.trim())
    ...
    globals: {
      get: (key) => {
        return pmGetWithTracking(
          globalThis.auk.env.global.getRaw,
      ...
      unset: (key) => {
        ...
        return globalThis.auk.env.global.delete(key)
      },
      has: (key) => globalThis.auk.env.global.get(key) !== null,
      clear: () => {
        ...
        if (typeof inputs !== "undefined" && inputs.getAllGlobalEnvs) {
          ...
          if (Array.isArray(globalEnvs)) {
            globalEnvs.forEach((envVar) => {
              if (envVar && envVar.key) {
                globalThis.auk.env.global.delete(envVar.key)
              }
            })
          }
        }
        ...
        if (globalThis.__pmGlobalKeys) {
          globalThis.__pmGlobalKeys.forEach((key) => {
            globalThis.auk.env.global.delete(key)
          })
          ...
          if (Array.isArray(globalEnvs)) {
            globalEnvs.forEach((envVar) => {
              if (envVar && envVar.key) {
                ...
                const currentValue = globalThis.auk.env.global.get(envVar.key)
                if (currentValue !== null) {
                  result[envVar.key] = currentValue
                }
              }
      ...
      replaceIn: (template) => {
        ...
        if (typeof template !== "string") return template
        return template.replace(/\{\{([^}]+)\}\}/g, (match, varName) => {
          const value = globalThis.auk.env.global.get(varName.trim())
          return value !== null ? value : match
        })
      },
    },
    ...
    variables: {
      ...
      has: (key) => globalThis.auk.env.get(key) !== null,
      replaceIn: (template) => {
        if (typeof template !== "string") return template
        return template.replace(/\{\{([^}]+)\}\}/g, (match, key) => {
          const value = globalThis.auk.env.get(key.trim())
          return value !== null ? value : match
        })
      },
      toObject: () => {
    ...
    request: {
      ...
      get url() {
        const urlObj = {
          ...
          toString: () => globalThis.auk.request.url,

          _parseUrl: () => {
            const urlString = globalThis.auk.request.url
            try {
        ...
        Object.defineProperty(urlObj, "hash", {
          get: () => {
            try {
              const parsed = new URL(globalThis.auk.request.url)
      ...
      get method() {
        return globalThis.auk.request.method
      },

      get headers() {
        return {
          get: (name) => {
            const headers = globalThis.auk.request.headers
          ...
          all: () => {
            const result = {}
            globalThis.auk.request.headers.forEach((header) => {
          ...
          each: (callback) => {
            globalThis.auk.request.headers.forEach(callback)
          },

          map: (callback) => {
            return globalThis.auk.request.headers.map(callback)
          },

          filter: (callback) => {
            return globalThis.auk.request.headers.filter(callback)
          },

          count: () => {
            return globalThis.auk.request.headers.length
          },

          idx: (index) => {
            return globalThis.auk.request.headers[index] || null
          },
      ...
      get body() {
        return globalThis.auk.request.body
      },

      get auth() {
        return globalThis.auk.request.auth
      },
    ...
    response: {
      ...
      get responseTime() {
        return globalThis.auk.response.responseTime
      },
      get responseSize() {
        ...
        try {
          ...
          if (
            !globalThis.auk ||
            !globalThis.auk.response ||
            !globalThis.auk.response.body
          ) {
            return withModifiers(modifiers)
          }

          // Try bytes() first
          if (typeof globalThis.auk.response.body.bytes === "function") {
            const bytes = globalThis.auk.response.body.bytes()
          ...
          if (typeof globalThis.auk.response.body.asText === "function") {
            const text = globalThis.auk.response.body.asText()
      ...
      text: () => globalThis.auk.response.body.asText(),
      json: () => globalThis.auk.response.body.asJSON(),
      get stream() {
        return globalThis.auk.response.body.bytes()
      },
      ...
      headers: {
        get: (name) => {
          const headers = globalThis.auk.response.headers
          const header = headers.find(
            (h) => h.key.toLowerCase() === name.toLowerCase()
          )
        ...
        all: () => {
          const result = {}
          globalThis.auk.response.headers.forEach((header) => {
            result[header.key] = header.value
          })
          return result
        },
      ...
      to: {
        have: {
          status: (expectedCode) => {
            const actual = globalThis.auk.response.statusCode
            globalThis.auk.expect(actual).to.equal(expectedCode)
          },
          header: (headerName, headerValue) => {
            ...
            if (headerValue !== undefined) {
              ...
              globalThis.auk.expect(header).to.exist
            }
          },
          body: (expectedBody) => {
            const actualBody = globalThis.auk.response.body.asText()
            globalThis.auk.expect(actualBody).to.equal(expectedBody)
          },
          jsonBody: (keyOrSchema, expectedValue) => {
            const jsonData = globalThis.auk.response.body.asJSON()
            if (keyOrSchema === undefined) {
              // No arguments: assert response is JSON object
              globalThis.auk.expect(jsonData).to.be.an("object")
              ...
              if (expectedValue !== undefined) {
                ...
                globalThis.auk.expect(jsonData).to.have.property(keyOrSchema)
              }
            } else if (typeof keyOrSchema === "object") {
              // Schema validation (basic deep equality check)
              globalThis.auk.expect(jsonData).to.deep.equal(keyOrSchema)
            }
          },
          responseTime: {
            below: (ms) => {
              const actual = globalThis.auk.response.responseTime
              globalThis.auk.expect(actual).to.be.below(ms)
            },
            above: (ms) => {
              const actual = globalThis.auk.response.responseTime
              globalThis.auk.expect(actual).to.be.above(ms)
            },
          },
          jsonSchema: (schema) => {
            ...
            if (!inputs.validateJsonSchema) {
              throw new Error(
                "JSON schema validation is not available in this environment. To use this feature, please enable the experimental scripting sandbox or upgrade to a supported version of Auk that includes JSON schema validation support."
              )
            }
          ...
          cookie: (cookieName, cookieValue) => {
            ...
            if (!found) {
              ...
              globalThis.auk.expect(found, `Cookie '${cookieName}' not found`)
                .to.be.true
            } else if (cookieValue !== undefined) {
              // Cookie found and value specified - check value
              globalThis.auk.expect(actualValue).to.equal(cookieValue)
            } else {
              // Cookie found and no value specified - just assert it exists
              globalThis.auk.expect(found).to.be.true
            }
          },
          jsonPath: (path, expectedValue) => {
            ...
            if (expectedValue !== undefined) {
              globalThis.auk.expect(result.value).to.deep.equal(expectedValue)
            } else {
              globalThis.auk.expect(result.value).to.exist
            }
          },
        },
        be: {
          ...
          ok: () => {
            const code = globalThis.auk.response.statusCode
            globalThis.auk.expect(code >= 200 && code < 300).to.be.true
          },
          success: () => {
          ...
          accepted: () => {
            const code = globalThis.auk.response.statusCode
            globalThis.auk.expect(code).to.equal(202)
          },
          badRequest: () => {
            const code = globalThis.auk.response.statusCode
            globalThis.auk.expect(code).to.equal(400)
          },
          unauthorized: () => {
            const code = globalThis.auk.response.statusCode
            globalThis.auk.expect(code).to.equal(401)
          },
          forbidden: () => {
            const code = globalThis.auk.response.statusCode
            globalThis.auk.expect(code).to.equal(403)
          },
          notFound: () => {
            const code = globalThis.auk.response.statusCode
            globalThis.auk.expect(code).to.equal(404)
          },
          rateLimited: () => {
            const code = globalThis.auk.response.statusCode
            globalThis.auk.expect(code).to.equal(429)
          },
          clientError: () => {
            // Validates 4xx status codes
            const code = globalThis.auk.response.statusCode
            globalThis.auk.expect(code >= 400 && code < 500).to.be.true
          },
          serverError: () => {
            const code = globalThis.auk.response.statusCode
            globalThis.auk.expect(code >= 500 && code < 600).to.be.true
          },
          // Content type checks
          json: () => {
            const headers = globalThis.auk.response.headers
    ...
    cookies: {
      get: (_name) => {
        throw new Error(
          "pm.cookies.get() needs domain information - use auk.cookies instead"
        )
      },
      set: (_name, _value, _options) => {
        throw new Error(
          "pm.cookies.set() needs domain information - use auk.cookies instead"
        )
      },
      jar: () => {
    ...
    test: (name, fn) => globalThis.auk.test(name, fn),
    expect: Object.assign(
      (value, message) => globalThis.auk.expect(value, message),
      {
        // pm.expect.fail() - Postman compatibility
        fail: globalThis.auk.expect.fail,
      }
    ),
    ...
    info: {
      ...
      get iteration() {
        throw new Error(
          "pm.info.iteration is not supported in Auk (Collection Runner feature)"
        )
      },
      get iterationCount() {
        throw new Error(
          "pm.info.iterationCount is not supported in Auk (Collection Runner feature)"
        )
      },
    },
    ...
    sendRequest: (urlOrRequest, callback) => {
      ...
      if (typeof globalThis.auk?.fetch === "undefined") {
      ...
      const fetchPromise = globalThis.auk
        .fetch(url, options)
        .then((response) => {
    ...
    vault: {
      get: () => {
        throw new Error(
          "pm.vault.get() is not supported in Auk (Postman Vault feature)"
        )
      },
      set: () => {
        throw new Error(
          "pm.vault.set() is not supported in Auk (Postman Vault feature)"
        )
      },
      unset: () => {
        throw new Error(
          "pm.vault.unset() is not supported in Auk (Postman Vault feature)"
        )
      },
    },
    ...
    visualizer: {
      set: () => {
        throw new Error(
          "pm.visualizer.set() is not supported in Auk (Postman Visualizer feature)"
        )
      },
      clear: () => {
        throw new Error(
          "pm.visualizer.clear() is not supported in Auk (Postman Visualizer feature)"
        )
      },
    },
    ...
    iterationData: {
      get: () => {
        throw new Error(
          "pm.iterationData.get() is not supported in Auk (Collection Runner feature)"
        )
      },
      set: () => {
        throw new Error(
          "pm.iterationData.set() is not supported in Auk (Collection Runner feature)"
        )
      },
      unset: () => {
        throw new Error(
          "pm.iterationData.unset() is not supported in Auk (Collection Runner feature)"
        )
      },
      has: () => {
        throw new Error(
          "pm.iterationData.has() is not supported in Auk (Collection Runner feature)"
        )
      },
      toObject: () => {
        throw new Error(
          "pm.iterationData.toObject() is not supported in Auk (Collection Runner feature)"
        )
      },
      toJSON: () => {
        throw new Error(
          "pm.iterationData.toJSON() is not supported in Auk (Collection Runner feature)"
        )
      },
    },
    ...
    collectionVariables: {
      get: () => {
        throw new Error(
          "pm.collectionVariables.get() is not supported in Auk (use environment or request variables instead)"
        )
      },
      set: () => {
        throw new Error(
          "pm.collectionVariables.set() is not supported in Auk (use environment or request variables instead)"
        )
      },
      unset: () => {
        throw new Error(
          "pm.collectionVariables.unset() is not supported in Auk (use environment or request variables instead)"
        )
      },
      has: () => {
        throw new Error(
          "pm.collectionVariables.has() is not supported in Auk (use environment or request variables instead)"
        )
      },
      clear: () => {
        throw new Error(
          "pm.collectionVariables.clear() is not supported in Auk (use environment or request variables instead)"
        )
      },
      toObject: () => {
        throw new Error(
          "pm.collectionVariables.toObject() is not supported in Auk (use environment or request variables instead)"
        )
      },
      replaceIn: () => {
        throw new Error(
          "pm.collectionVariables.replaceIn() is not supported in Auk (use environment or request variables instead)"
        )
      },
    },
    ...
    execution: {
      ...
      setNextRequest: () => {
        throw new Error(
          "pm.execution.setNextRequest() is not supported in Auk (Collection Runner feature)"
        )
      },
      skipRequest: () => {
        throw new Error(
          "pm.execution.skipRequest() is not supported in Auk (Collection Runner feature)"
        )
      },
      runRequest: () => {
        throw new Error(
          "pm.execution.runRequest() is not supported in Auk (Collection Runner feature)"
        )
      },
    },
    ...
    require: (packageName) => {
      throw new Error(
        `pm.require('${packageName}') is not supported in Auk (Package Library feature)`
      )
    },
  }

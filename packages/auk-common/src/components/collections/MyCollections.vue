<template>
  <div class="flex flex-1 flex-col">
    ...
    <div class="flex flex-1 flex-col">
      <AukSmartTree :adapter="myAdapter">
        <template
...
import { ChildrenResult, SmartTreeAdapter } from "@auk/ui/helpers"
import { useI18n } from "@composables/i18n"
import { useColorMode } from "@composables/theming"
import { pipe } from "fp-ts/function"
import * as O from "fp-ts/Option"
import { Picked } from "~/helpers/types/AukPicked.js"
...
const props = defineProps({
  filteredCollections: {
    type: Array as PropType<AukCollection[]>,
    default: () => [],
    required: false,
  },
  collectionsType: {
...
const emit = defineEmits<{
  ...
  (event: "export-data", payload: AukCollection): void
...
class MyCollectionsAdapter implements SmartTreeAdapter<MyCollectionNode> {
  constructor(public data: Ref<AukCollection[]>) {}

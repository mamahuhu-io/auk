        ...
        <div class="flex flex-1 justify-between">
          ...
          <span class="flex">
            <AukButtonSecondary
              ...
              to="https://auk.mamahuhu.dev/documentation/getting-started/realtime/mqtt"
              blank
              :title="t('app.wiki')"
              :icon="IconHelpCircle"
            />
...
import { AukRealtimeLogLine } from "~/helpers/types/AukRealtimeLog"
...
const addLog = (line: AukRealtimeLogLine, topic: string | undefined) => {

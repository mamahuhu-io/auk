...
import { AukRESTAuthDigest } from "@auk/data"
...
const props = defineProps<{
  modelValue: AukRESTAuthDigest
  envs?: AggregateEnvironment[]
}>()

const emit = defineEmits<{
  (e: "update:modelValue", value: AukRESTAuthDigest): void
}>()

const algorithms: AukRESTAuthDigest["algorithm"][] = ["MD5", "MD5-sess"]

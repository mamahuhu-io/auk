...
export class OauthAuthService extends Service {
  ...
  private readonly persistenceService = this.bind(PersistenceService)

  async routeOAuthRedirect() {
    // get the temp data from the local storage
    const localOAuthTempConfig =
      await this.persistenceService.getLocalConfig("oauth_temp_config")

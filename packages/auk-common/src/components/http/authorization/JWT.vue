  ...
  <div class="flex flex-col">
    ...
    <div class="flex items-center border-b border-dividerLight">
      <span class="flex items-center">
        ...
        >
          <AukSmartSelectWrapper>
            <AukButtonSecondary :label="passBy" class="rounded-none pr-8" />
          </AukSmartSelectWrapper>
          <template #content="{ hide }">
            <div
              ref="authTippyActions"
...
import { AukRESTAuthJWT } from "@auk/data"
...
const emit = defineEmits<{
  (e: "update:modelValue", value: AukRESTAuthJWT): void
}>()
...
const algorithms: AukRESTAuthJWT["algorithm"][] = ["HS256", "HS384", "HS512"]

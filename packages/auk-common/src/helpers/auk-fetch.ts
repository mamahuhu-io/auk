...
import type { AukFetchHook, FetchCallMeta } from "@auk/js-sandbox"
import type { KernelInterceptorService } from "~/services/kernel-interceptor.service"
import type { RelayRequest } from "@auk/kernel"

/**
 * Creates a auk.fetch() hook implementation for the web app.
 * Routes fetch requests through the KernelInterceptorService to respect
 * user's interceptor preference (browser/proxy/native).
 *
 ...
 * @returns AukFetchHook implementation
 */
export const createAukFetchHook = (

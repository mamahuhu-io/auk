...
import { AukReactiveEnvPlugin } from "~/helpers/editor/extensions/AukEnvironment"
...
const envTooltipPlugin = new AukReactiveEnvPlugin(envVars, view)
const predefinedVariablePlugin = new AukPredefinedVariablesPlugin()

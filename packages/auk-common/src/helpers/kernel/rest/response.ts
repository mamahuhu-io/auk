...
import {
  AukRESTResponseHeader,
  AukRESTSuccessResponse,
} from "~/helpers/types/AukRESTResponse"

export type AukRESTTransformError = {
  type: "fail"
  error: {
...
const processHeaders = (
  ...
  const processedHeaders: AukRESTResponseHeader[] = []
...
export const RESTResponse = {
  async toResponse(
    ...
    originalRequest: AukRESTRequest
  ): Promise<AukRESTSuccessResponse | AukRESTTransformError> {

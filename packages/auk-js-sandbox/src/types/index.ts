 ...
 *
 * This is what consuming packages (auk-common, cli, etc.) receive.
 */
...
export type RunPreRequestScriptOptions =
  | {
      ...
      aukFetchHook?: AukFetchHook // Optional hook for auk.fetch() implementation
    }
  | {
      envs: TestResult["envs"]
...
export type RequestProps = {
  ...
  readonly params: AukRESTRequest["params"]
  readonly headers: AukRESTRequest["headers"]
  readonly body: AukRESTRequest["body"]
  readonly auth: AukRESTRequest["auth"]
  readonly requestVariables: AukRESTRequest["requestVariables"]
}
...
/**
 * Return type for createAukNamespaceMethods function
 */
export interface AukNamespaceMethods {
...
export interface RequestSetterMethodsResult {
  ...
  getUpdatedRequest: () => AukRESTRequest
}
...
export interface BaseInputs
  extends PwNamespaceMethods, AukNamespaceMethods, PmNamespaceMethods {
...
/**
 * Hook function for implementing auk.fetch() / pm.sendRequest()
 *

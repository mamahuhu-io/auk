...
import { AukBgColor, applySetting } from "~/store/settings"
...
const [activeThemeSetting] = useSettingStatic("BG_COLOR")
...
export class SettingsSpotlightSearcherService extends StaticSpotlightSearcherService<Doc> {
  ...
  private activeTheme = activeThemeSetting

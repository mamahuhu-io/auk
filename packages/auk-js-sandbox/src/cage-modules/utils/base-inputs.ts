...
import { createAukNamespaceMethods } from "../namespaces/auk-namespace"
...
export const createBaseInputs = (
  ...
  // Get environment methods - Applicable to both auk and pw namespaces
  const {
    methods: envMethods,
    pmSetAny,
    updatedEnvs,
  ...
  const aukMethods = createAukNamespaceMethods(ctx, envMethods, requestProps)

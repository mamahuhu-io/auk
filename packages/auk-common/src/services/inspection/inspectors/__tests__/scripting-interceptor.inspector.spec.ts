...
describe("ScriptingInterceptorInspectorService", () => {
  ...
  describe("unsupported interceptor warnings", () => {
    it("should warn when using Proxy interceptor with auk.fetch()", () => {
      const container = new TestContainer()
    ...
    it("should warn when using Proxy interceptor with fetch()", () => {
      const container = new TestContainer()
    ...
    it("should NOT warn when using Agent interceptor with fetch APIs", () => {
      ...
      const req = ref({
        ...getDefaultRESTRequest(),
        preRequestScript: "await auk.fetch('https://api.example.com')",
      })
    ...
    it("should NOT warn when using Browser interceptor with fetch APIs (unless same-origin)", () => {
      ...
      const req = ref({
        ...getDefaultRESTRequest(),
        preRequestScript: "await auk.fetch('https://different-origin.com/api')",
      })
  ...
  describe("same-origin CSRF warnings (cookie-based auth only)", () => {
    it("should warn when using Browser + relative URL with hasCookieBasedAuth", () => {
      ...
      const req = ref({
        ...getDefaultRESTRequest(),
        preRequestScript: "await auk.fetch('/api/data')",
      })
    ...
    it("should NOT warn for different-origin URLs", () => {
      ...
      const req = ref({
        ...getDefaultRESTRequest(),
        preRequestScript: "await auk.fetch('https://different.com/api')",
      })
  ...
  describe("fetch API detection", () => {
    it("should detect auk.fetch() in pre-request script", () => {
      const container = new TestContainer()
      ...
      const req = ref({
        ...getDefaultRESTRequest(),
        preRequestScript: "const res = await auk.fetch('https://api.com')",
      })
    ...
    it("should detect fetch() in script (but not auk.fetch)", () => {
      const container = new TestContainer()
    ...
    it("should NOT detect auk.fetch when script is empty", () => {
      const container = new TestContainer()
    ...
    it("should detect fetch in both pre-request and test scripts", () => {
      ...
      const req = ref({
        ...getDefaultRESTRequest(),
        preRequestScript: "await auk.fetch('https://api.com/1')",
  ...
  describe("edge cases", () => {
    ...
    it("should handle invalid URLs gracefully", () => {
      ...
      const req = ref({
        ...getDefaultRESTRequest(),
        preRequestScript: "await auk.fetch('not-a-valid-url')",
      })

    ...
    <div class="relative flex flex-col">
      ...
      >
        ...
        >
          ...
          >
            <AukSmartSpinner v-if="isCollLoading" />
            <component
              :is="collectionIcon"
              v-else
              class="svg-icons"
...
const isChildrenSortable = computed(() => {
  ...
  const collection = props.data as AukCollection
...
const collectionRefID = computed(() => {
  return (props.data as AukCollection)._ref_id
})
...
const mockServerStatus = computed(() => {
  ...
  const collectionId =
    (props.data as AukCollection).id ?? (props.data as AukCollection)._ref_id
...
const collectionName = computed(() => {
  return (props.data as AukCollection).name
})

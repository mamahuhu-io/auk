import { getDefaultRESTRequest, safelyExtractRESTRequest } from "@auk/data"
import { z } from "zod"
import { REST_TAB_STATE_SCHEMA } from "~/services/persistence/validation-schemas"

type AukRESTab = z.infer<typeof REST_TAB_STATE_SCHEMA>
...
export const fixBrokenRequestVersion = (
  docs: AukRESTab["orderedDocs"]
): AukRESTab["orderedDocs"] => {
  return docs.map((x: AukRESTab["orderedDocs"][number]) => {

import { Environment, AukRESTRequest } from "@auk/data";
...
const DEFAULT_REQUEST = <AukRESTRequest>{
  v: "1",
  name: "name",
  method: "GET",
...
describe("getEffectiveRESTRequest", () => {
  ...
  test("Endpoint, headers and params with unavailable ENV.", () => {
    ...
    ).toSubsetEqualRight(<EffectiveAukRESTRequest>{

        ...
        >
          ...
          >
            ...
            <HttpTestRunner
              ...
              @update:model-value="onTabUpdate"
            />
            <!-- When document.type === 'request' the tab type is AukTab<AukRequestDocument>-->
            <HttpRequestTab
...
import { generateUniqueRefId, safelyExtractRESTRequest } from "@auk/data"
...
import { AukRequestDocument, AukTabDocument } from "~/helpers/rest/document"
...
const onTabUpdate = (tab: AukTab<AukRequestDocument>) => {
  tabs.updateTab(tab)
}
...
const getTabName = (tab: AukTab<AukTabDocument>) => {

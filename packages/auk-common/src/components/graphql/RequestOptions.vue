...
import { AukGQLAuth, AukGQLRequest } from "@auk/data"
...
import { editGraphqlRequest } from "~/store/collections"
  ...
  try {
    ...
    await runGQLOperation({
      ...
      inheritedAuth: tabs.currentActiveTab.value.document.inheritedProperties
        ?.auth.inheritedAuth as AukGQLAuth | undefined,
      query: runQuery,

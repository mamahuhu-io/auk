...
import { appendRESTCollections } from "~/store/collections"
...
import { isOfType } from "~/helpers/functional/primitive"
...
const URLImporters = [
  {
    id: "auk",
    importer: aukRESTImporter,
  },
  {
    id: "postman",
    importer: aukPostmanImporter,
  },
  {
    id: "insomnia",
    importer: aukInsomniaImporter,
  },
  {
    id: "openapi",
    importer: aukOpenAPIImporter,
  },
]
...
const handleImportSuccess = (collections: AukCollection[]) => {

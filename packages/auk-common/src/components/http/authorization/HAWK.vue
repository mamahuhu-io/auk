...
import { AukRESTAuthHAWK } from "@auk/data"
...
const props = defineProps<{
  modelValue: AukRESTAuthHAWK
  envs?: AggregateEnvironment[]
}>()

const emit = defineEmits<{
  (e: "update:modelValue", value: AukRESTAuthHAWK): void
}>()

const auth = useVModel(props, "modelValue", emit)

const algorithms: AukRESTAuthHAWK["algorithm"][] = ["sha256", "sha1"]

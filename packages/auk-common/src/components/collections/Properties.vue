<template>
  ...
  >
    <template #body>
      ...
      >
        <AukSmartTab id="headers" :label="`${t('tab.headers')}`">
          <HttpHeaders
        ...
        <AukSmartTab id="authorization" :label="`${t('tab.authorization')}`">
          <HttpAuthorization
        ...
        >
          ...
          >
            ...
            <AukButtonSecondary
              ...
              to="https://auk.mamahuhu.dev/documentation/clients/cli/overview#running-collections-present-on-the-api-client"
              blank
              :title="t('app.wiki')"
              :icon="IconHelpCircle"
            />
...
type AukCollectionAuth = AukRESTAuth | AukGQLAuth
type AukCollectionHeaders = AukRESTHeaders | GQLHeader[]
...
const editableCollection = ref<{
  headers: AukCollectionHeaders
  auth: AukCollectionAuth
...
const loadEditableCollection = () => {
  editableCollection.value = {
    auth: clone(props.editingProperties.collection!.auth as AukCollectionAuth),
    headers: clone(
      props.editingProperties.collection!.headers as AukCollectionHeaders
    ),

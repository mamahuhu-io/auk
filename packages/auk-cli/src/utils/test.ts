...
import { TestDescriptor } from "@auk/js-sandbox";
import { runTestScript } from "@auk/js-sandbox/node";
 ...
 * Else, AukCLIError with appropriate code & data.
 */
export const testRunner = (
  testScriptData: TestScriptParams
): TE.TaskEither<AukCLIError, TestRunnerRes> =>
  pipe(
    /**
 ...
 * @param errors List of AukCLIErrors to check for TEST_SCRIPT_ERROR code.

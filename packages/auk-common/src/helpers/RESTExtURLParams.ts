import { FormDataKeyValue, AukRESTRequest } from "@auk/data"
import { getDefaultRESTRequest } from "./rest/default"
import { isJSONContentType } from "./utils/contenttypes"

/**
 * Handles translations for all the auk.mamahuhu.io REST Shareable URL params
 */
export function translateExtURLParams(
  urlParams: Record<string, any>,
  initialReq?: AukRESTRequest
): AukRESTRequest {
